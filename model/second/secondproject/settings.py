...
#SECRET_KEY = 'lblz3ygl)8)-*jbh@q)8@mju=oa6(%5_-lj8i)s%z86q2pu@$g'
import os
ECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', 'cg## SECURITY WARNING: keep the secret key used in production secret!
